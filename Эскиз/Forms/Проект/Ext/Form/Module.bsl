...
Функция СоздатьПроект() Экспорт
	...
	ВспомогательныеДанные.Вставить("СчетчикФорм", 1);
	ВспомогательныеДанные.Вставить("СчетчикиЭлементовФорм", Новый Структура);
	ВспомогательныеДанные.Вставить("Прототипы", Новый Структура);
...
&НаКлиенте
Функция ЗагрузитьВспомогательныеДанные(Данные) Экспорт
...
Функция ПолучитьТекущийПрототип(ТекущиеДанные, РодительскаяФорма) 
	...
	Если ВспомогательныеДанные.Прототипы.Свойство(ТекущиеДанные.Имя, Результат) И Результат <> Неопределено Тогда
		//todo
	...
	Иначе
		...
		ВспомогательныеДанные.Прототипы.Вставить(ТекущиеДанные.Имя, Результат);
...
Процедура АктивизироватьТекущийЭлемент(ИмяПрототипа, ИмяЭлемента) Экспорт
	ТекущийПрототип = ВспомогательныеДанные.Прототипы[ИмяПрототипа];
...
Функция ПолучитьНовоеИмяЭлемента(ИмяФормы, ИмяЭлемента) Экспорт
	...
	Если Не ТекущийСчетчик.Свойство(ИмяЭлемента) Тогда
		ТекущийСчетчик.Вставить(ИмяЭлемента, 1);
...
Функция ДобавитьЭлементУправления(СвойстваЭлементаУправления, Связать, Перемещение) Экспорт
	ТекущийПрототип = ВспомогательныеДанные.Прототипы[СвойстваЭлементаУправления.Прототип];
...
Функция ПереместитьЭлементУправления(ДанныеПеремещения) Экспорт
	ТекущийПрототип = ВспомогательныеДанные.Прототипы[ДанныеПеремещения.Прототип];
...
Процедура ИзменитьСвойство(Прототип, Свойство, Значение, ЭтоФорма = Истина, Элемент = "") Экспорт
	ТекущийПрототип = ВспомогательныеДанные.Прототипы[Прототип];
