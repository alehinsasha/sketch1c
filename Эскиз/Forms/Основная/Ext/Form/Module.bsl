...
Процедура ДобавитьЭлементУправления(Тип, Вид = "", ТипЗначения = "", ЭтоТаблица = Ложь)
	...
	НоваяСтрока.ИмяТаблицы = ПолучитьИмяТаблицыРекурсивно();
