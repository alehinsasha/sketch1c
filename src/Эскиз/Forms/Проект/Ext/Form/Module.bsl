...
Процедура ДобавитьЭлементУправления(СпециальныеСвойства, ТиповыеСвойства, Связать, Перемещение) Экспорт
	ТекущийПрототип = Прототипы[СпециальныеСвойства.Прототип];
...
&НаКлиенте
Процедура УдалитьФорму(ИмяПрототипа) Экспорт
	ТекущийПрототип = Прототипы[ИмяПрототипа];
	Если ТекущийПрототип.Открыта() Тогда
...
&НаКлиенте
Процедура УдалитьЭлементУправления(ИмяПрототипа, ИмяЭлемента, ИмяРеквизита, ЭтоКоманда, ЭтоКолонка = Ложь, ИмяТаблицы = "") Экспорт
	ТекущийПрототип = Прототипы[ИмяПрототипа];
...
&НаКлиенте
Процедура ИзменитьТипЗначения(Прототип, Свойство, Значение, ЭтоФорма = Истина, Элемент = "", Путь = "", СоставДаты = "") Экспорт
	ТекущийПрототип = Прототипы[Прототип];
	ТекущийПрототип.ИзменитьТипЗначения(Свойство, Значение, ЭтоФорма, Элемент, Путь, СоставДаты);
