...
Процедура ОпределитьСвойства(ТекущиеДанные) Экспорт
	...
	Для Каждого Строка Из ИскомыеСтроки Цикл
		...
		Если Истина
			...
			И Строка.Свойство <> "КартинкаЗначений"
			Тогда
...
Процедура ЗначениеНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	Иначе
		Если ЕстьДанныеВыбора(ТекущиеДанныеСвойства) Тогда
			...
			Если ТекущиеДанныеСвойства.Свойство = "Группировка" Тогда
				...
				КонецЕсли;
			ИначеЕсли ТекущиеДанныеСвойства.Свойство = "Отображение" Тогда
				Если Ложь
		...
		Иначе
			...
			Если Ложь
				Или ТекущиеДанныеСвойства.Свойство = "Картинка"
				Или ТекущиеДанныеСвойства.Свойство = "КартинкаЗначений"
				Тогда
