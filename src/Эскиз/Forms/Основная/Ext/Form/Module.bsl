...
&НаКлиенте
Функция ЗаполнитьСвойстваЗначениямиПоУмолчанию(НоваяСтрока)
	Результат = "";
	...
	Для Каждого Строка Из ИскомыеСтроки Цикл
		...
		Если Строка.ДанныеВыбора.Количество()
			Или Строка.ДанныеВыбора_ГруппаКолонок.Количество() Тогда
...
Процедура ВыборИзВыпадающегоСпискаЗавершение(ВыбранныйЭлемент, ДополнительныеПараметры) Экспорт
	...
	Если Не ВыбранныйЭлемент = Неопределено Тогда
		...
		ТекущиеДанныеПрототип = Элементы.ФормыИЭлементыУправления.ТекущиеДанные;
		Если ТекущиеДанныеСвойства.Свойство	= "ТипЗначения" Тогда
			ТекущиеДанныеПрототип.РежимВыбораИзСписка = Ложь;
			ТекущиеДанныеПрототип.СписокВыбора.Очистить();
