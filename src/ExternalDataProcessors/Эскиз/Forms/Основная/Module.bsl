...
Процедура СоздатьПрототип(Команда)
	...
	НовоеИмя = МенеджерПрототипов.ПолучитьНовоеИмяФормы();
	НоваяСтрока.Имя = НовоеИмя;
	НоваяСтрока.Заголовок = НовоеИмя;
	НоваяСтрока.Тип = МенеджерПрототипов.Типы().ФормаКлиентскогоПриложения;
...
&НаКлиенте
Процедура ЗагрузитьПрототип(Команда)
	
	ОписаниеОповещенияОЗавершении = Новый ОписаниеОповещения("ЗагрузитьПрототипЗавершение", ЭтотОбъект);
	МенеджерФайлов.ЗагрузитьФайл("", Ложь, ОписаниеОповещенияОЗавершении);
...
Процедура СохранитьПрототип(Команда)
	...
	Если СохранитьПрототипНаСервере(СтрокуПрототипа.Идентификатор, Адрес) Тогда
		МенеджерФайлов.СохранитьФайл(РасположениеПроекта, Адрес, Ложь);
		
		
		ТекущиеДанные.Модифицированность = Ложь;
		ТекущиеДанные.ИндексКартинки = ИндексКартинкиФормы(ТекущиеДанные.Модифицированность);
	КонецЕсли;
...
Процедура ДобавитьГруппу(Команда)
	...
	ДобавитьЭлементУправления(МенеджерПрототипов.Типы().ГруппаФормы, МенеджерПрототипов.Виды().ОбычнаяГруппа);
...
Процедура ДобавитьКоманднуюПанель(Команда)
	...
	ДобавитьЭлементУправления(МенеджерПрототипов.Типы().ГруппаФормы, МенеджерПрототипов.Виды().КоманднаяПанель);
...
Процедура ДобавитьПодменю(Команда)
	...
	ДобавитьЭлементУправления(МенеджерПрототипов.Типы().ГруппаФормы, МенеджерПрототипов.Виды().Подменю);
...
Процедура ДобавитьСтраницы(Команда)
	...
	ДобавитьЭлементУправления(МенеджерПрототипов.Типы().ГруппаФормы, МенеджерПрототипов.Виды().Страницы);
...
Процедура ДобавитьСтраницу(Команда)
	...
	ДобавитьЭлементУправления(МенеджерПрототипов.Типы().ГруппаФормы, МенеджерПрототипов.Виды().Страница);
...
Процедура ДобавитьКнопку(Команда)
	...
	ДобавитьЭлементУправления(МенеджерПрототипов.Типы().КнопкаФормы, МенеджерПрототипов.Виды().ОбычнаяКнопка);
...
Процедура ДобавитьКнопкуКоманднойПанели(Команда)
	...
	ДобавитьЭлементУправления(МенеджерПрототипов.Типы().КнопкаФормы, МенеджерПрототипов.Виды().КнопкаКоманднойПанели);
...
Процедура ДобавитьГиперссылку(Команда)
	...
	ДобавитьЭлементУправления(МенеджерПрототипов.Типы().КнопкаФормы, МенеджерПрототипов.Виды().Гиперссылка);
...
Процедура ДобавитьГиперссылкуКоманднойПанели(Команда)
	...
	ДобавитьЭлементУправления(МенеджерПрототипов.Типы().КнопкаФормы, МенеджерПрототипов.Виды().ГиперссылкаКоманднойПанели);
...
Процедура ДобавитьПоле(Команда)
	...
	ДобавитьЭлементУправления(МенеджерПрототипов.Типы().ПолеФормы, МенеджерПрототипов.Виды().ПолеВвода);
...
Процедура ДобавитьФлажок(Команда)
	...
	ДобавитьЭлементУправления(МенеджерПрототипов.Типы().ПолеФормы, МенеджерПрототипов.Виды().ПолеФлажка);
...
Процедура ДобавитьПереключатель(Команда)
	...
	ДобавитьЭлементУправления(МенеджерПрототипов.Типы().ПолеФормы, МенеджерПрототипов.Виды().ПолеПереключателя);
...
Процедура ДобавитьТаблицу(Команда)
	...
	ДобавитьЭлементУправления(МенеджерПрототипов.Типы().ТаблицаФормы, , МенеджерПрототипов.ТипыЗначения().ТаблицаЗначений);
...
Процедура ДобавитьДерево(Команда)
	...
	ДобавитьЭлементУправления(МенеджерПрототипов.Типы().ТаблицаФормы, , МенеджерПрототипов.ТипыЗначения().ДеревоЗначений);
...
Процедура ДобавитьКолонку(Команда)
	...
	ДобавитьЭлементУправления(МенеджерПрототипов.Типы().ПолеФормы, МенеджерПрототипов.Виды().ПолеВвода, , Истина);
...
Процедура ДобавитьГруппуКолонок(Команда)
	...
	ДобавитьЭлементУправления(МенеджерПрототипов.Типы().ГруппаФормы, МенеджерПрототипов.Виды().ГруппаКолонок);
...
Процедура ДобавитьКонтекстноеМеню(Команда)
	...
	ДобавитьЭлементУправления(МенеджерПрототипов.Типы().ГруппаФормы, МенеджерПрототипов.Виды().КонтекстноеМеню);
...
Процедура ДобавитьНадпись(Команда)
	...
	ДобавитьЭлементУправления(МенеджерПрототипов.Типы().ДекорацияФормы, МенеджерПрототипов.Виды().Надпись);
...
Процедура ДобавитьКартинку(Команда)
	...
	//ДобавитьЭлементУправления(МенеджерПрототипов.Типы().ДекорацияФормы, МенеджерПрототипов.Виды().Картинка);
	ДобавитьЭлементУправления(МенеджерПрототипов.Типы().ПолеФормы, МенеджерПрототипов.Виды().ПолеКартинки);
...
Процедура ДобавитьИндикатор(Команда)
	...
	ДобавитьЭлементУправления(МенеджерПрототипов.Типы().ПолеФормы, МенеджерПрототипов.Виды().ПолеИндикатора);
...
Процедура ДобавитьПолосуРегулирования(Команда)
	...
	ДобавитьЭлементУправления(МенеджерПрототипов.Типы().ПолеФормы, МенеджерПрототипов.Виды().ПолеПолосыРегулирования);
...
Процедура ДобавитьКалендарь(Команда)
	...
	ДобавитьЭлементУправления(МенеджерПрототипов.Типы().ПолеФормы, МенеджерПрототипов.Виды().ПолеКалендаря);
...
Процедура ДобавитьФорматированныйДокумент(Команда)
	...
	ДобавитьЭлементУправления(МенеджерПрототипов.Типы().ПолеФормы, МенеджерПрототипов.Виды().ПолеФорматированногоДокумента);
...
Процедура ДобавитьФорматированнуюСтроку(Команда)
	...
	ДобавитьЭлементУправления(МенеджерПрототипов.Типы().ПолеФормы, МенеджерПрототипов.Виды().ПолеНадписи);
...
Процедура ДобавитьТекстовыйДокумент(Команда)
	...
	ДобавитьЭлементУправления(МенеджерПрототипов.Типы().ПолеФормы, МенеджерПрототипов.Виды().ПолеТекстовогоДокумента);
...
Процедура ДобавитьТабличныйДокумент(Команда)
	...
	ДобавитьЭлементУправления(МенеджерПрототипов.Типы().ПолеФормы, МенеджерПрототипов.Виды().ПолеТабличногоДокумента);
...
Процедура ДобавитьГруппуКнопок(Команда)
	...
	ДобавитьЭлементУправления(МенеджерПрототипов.Типы().ГруппаФормы, МенеджерПрототипов.Виды().ГруппаКнопок);
...
Процедура НастройкиПроекта(Команда)
	...
	ОткрытьФорму("ВнешняяОбработка.Эскиз.Форма.НастройкиПроекта", ПараметрыФормы, ЭтаФорма, , , ,
	ОписаниеОповещенияОЗакрытии, РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
...
Функция СохранитьПрототипНаСервере(Идентификатор, Адрес) 
	...
	ДанныеПрототипа = ФормыИЭлементыУправленияВМассивРекурсивно(ВременныйМассив, Ключи);
...
Процедура ЗагрузитьПрототипЗавершение(Адрес, ДополнительныеПараметры) Экспорт
	...
	Если Не ПустаяСтрока(Адрес) Тогда
		Если ЗагрузитьПрототипНаСервере(Адрес, Идентификатор, Замена) Тогда
...
&НаСервере
Функция ЗагрузитьПрототипНаСервере(Адрес, Идентификатор, Замена) 
	...
	Если ДанныеПрототипа.Количество() Тогда
		...
		ФормыИЭлементыУправленияИзМассиваРекурсивно(ДанныеПрототипа, ФормыИЭлементыУправленияНаСервере.Строки, Истина, Замена);
...
&НаКлиенте
Процедура ИнициализироватьПроект()
	
	МенеджерПрототипов = ПолучитьФорму("ВнешняяОбработка.Эскиз.Форма.Проект");
	МенеджерПрототипов.СоздатьПроект();
...
Процедура ВыбратьПроект(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	Если ЭтаФорма.ФормыИЭлементыУправления.ПолучитьЭлементы().Количество() Тогда
		ОписаниеОповещенияОЗавершении = Новый ОписаниеОповещения("ОчиститьПроектПередВыбором", ЭтотОбъект);
		ПоказатьВопрос(ОписаниеОповещенияОЗавершении, "Проект будет очищен! Продолжить?", РежимДиалогаВопрос.ДаНет, 60, КодВозвратаДиалога.Нет,, КодВозвратаДиалога.Нет);
		
	Иначе
		ВыбратьПроектПродолжение();
		
	КонецЕсли;
КонецПроцедуры

&НаКлиенте
Процедура ОчиститьПроектПередВыбором(Ответ, ДополнительныеПараметры) Экспорт
...
&НаКлиенте
Процедура ВыбратьПроектПродолжение() 
...
Процедура ВыбратьПроектЗавершение(ВыбранныеФайлы, ДополнительныеПараметры) Экспорт
	//Если Ложь Или ВыбранныеФайлы = Неопределено Или ВыбранныеФайлы.Количество() = 0 Тогда
	//	
	...
	//МенеджерПрототипов.ЗагрузитьВспомогательныеДанные(Проект.ВспомогательныеДанные);
	//
КонецПроцедуры

&НаСервере
Процедура ФормыИЭлементыУправленияИзМассиваРекурсивно(Строки, Родитель, ПервыйУровень, Замена)
...
Процедура ЗагрузитьПрототипРекурсивно(Строки)
	...
	Для Каждого Строка Из Строки Цикл
		Если Строка.Тип = МенеджерПрототипов.Типы().ФормаКлиентскогоПриложения Тогда
			МенеджерПрототипов.ОткрытьПрототип(Строка, ЭтаФорма, Ложь);
		Иначе
			Связать = Ложь;
			Если Строка.Тип = МенеджерПрототипов.Типы().ПолеФормы
				Или Строка.Тип = МенеджерПрототипов.Типы().КнопкаФормы 
				Или Строка.Тип = МенеджерПрототипов.Типы().ТаблицаФормы Тогда
...
Процедура СохранитьПроектПродолжение()
	ВспомогательныеДанные = МенеджерПрототипов.ПолучитьВспомогательныеДанные();
...
Процедура РасположениеПроектаОчистка(Элемент, СтандартнаяОбработка)
	...
	ПоказатьВопрос(ОписаниеОповещения, "Проект будет очищен! Продолжить?",
	РежимДиалогаВопрос.ДаНет, 60, КодВозвратаДиалога.Нет, "Эскиз", КодВозвратаДиалога.Нет);
...
Процедура АктивизироватьТекущийЭлемент() Экспорт
	...
	Если ТекущиеДанные.Тип = МенеджерПрототипов.Типы().ФормаКлиентскогоПриложения Тогда
...
Функция ПолучитьПараметрыОтбораСвойств(ТекущиеДанные)
	...
	ИначеЕсли ТекущиеДанные.Тип = МенеджерПрототипов.Типы().ФормаКлиентскогоПриложения Тогда
		КлючОтбора = КлючОтбора + ТекущиеДанные.Тип;
		
	ИначеЕсли ТекущиеДанные.Тип = МенеджерПрототипов.Типы().ТаблицаФормы Тогда
		КлючОтбора = КлючОтбора + ТекущиеДанные.Тип + "_";
		КлючОтбора = КлючОтбора + ТекущиеДанные.ТипЗначения;
		
	ИначеЕсли Истина И ТекущиеДанные.Тип = МенеджерПрототипов.Типы().ПолеФормы И ТекущиеДанные.Вид
		= МенеджерПрототипов.Виды().ПолеВвода Тогда
...
Процедура ОпределитьСвойства() Экспорт
	...
	Для Каждого Строка Из ИскомыеСтроки Цикл
		...
		Если Строка.ВариантЗаполнения = МенеджерПрототипов.ВариантыЗаполнения().ВыборИзВыпадающегоСписка Тогда
...
Процедура ОпределитьГруппуКоманд()
	...
	Иначе
		...
		Если ТекущиеДанные.Тип = МенеджерПрототипов.Типы().ГруппаФормы Тогда
			Если ТекущиеДанные.Вид = МенеджерПрототипов.Виды().Страницы Тогда
				Элементы.ГруппаКоманды.ТекущаяСтраница = Элементы.ГруппаКоманды_Страницы;
			ИначеЕсли ТекущиеДанные.Вид = МенеджерПрототипов.Виды().КоманднаяПанель
				Или ТекущиеДанные.Вид = МенеджерПрототипов.Виды().Подменю
				Или ТекущиеДанные.Вид = МенеджерПрототипов.Виды().ГруппаКнопок
				Или ТекущиеДанные.Вид = МенеджерПрототипов.Виды().КонтекстноеМеню Тогда
				
				Элементы.ГруппаКоманды.ТекущаяСтраница = Элементы.ГруппаКоманды_КоманднаяПанель;
			ИначеЕсли ТекущиеДанные.Вид = МенеджерПрототипов.Виды().ГруппаКолонок Тогда
				Элементы.ГруппаКоманды.ТекущаяСтраница = Элементы.ГруппаКоманды_Таблица;
			КонецЕсли;
		ИначеЕсли ТекущиеДанные.Тип = МенеджерПрототипов.Типы().ТаблицаФормы Тогда
			Элементы.ГруппаКоманды.ТекущаяСтраница = Элементы.ГруппаКоманды_Таблица;
		ИначеЕсли ТекущиеДанные.Тип = МенеджерПрототипов.Типы().КнопкаФормы Тогда
			Родитель = ТекущиеДанные.ПолучитьРодителя();
			Если Родитель.Вид = МенеджерПрототипов.Виды().КоманднаяПанель
				Или Родитель.Вид = МенеджерПрототипов.Виды().Подменю
				Или Родитель.Вид = МенеджерПрототипов.Виды().ГруппаКнопок
				Или Родитель.Вид = МенеджерПрототипов.Виды().КонтекстноеМеню Тогда
				
				Элементы.ГруппаКоманды.ТекущаяСтраница = Элементы.ГруппаКоманды_КоманднаяПанель;
			КонецЕсли;
		ИначеЕсли ТекущиеДанные.Тип = МенеджерПрототипов.Типы().ПолеФормы Тогда
			Родитель = ТекущиеДанные.ПолучитьРодителя();
			Если Родитель.Тип = МенеджерПрототипов.Типы().ТаблицаФормы
				Или Родитель.Вид = МенеджерПрототипов.Виды().ГруппаКолонок Тогда
...
Процедура ОбработатьИзменениеСвойства()
	...
	Если ТекущиеДанныеПрототип.Тип = МенеджерПрототипов.Типы().ФормаКлиентскогоПриложения Тогда
	...
	Иначе
		...
		Если ТекущиеДанныеСвойств.Свойство = "ТипЗначения" 
			...
			МенеджерПрототипов.СоздатьИзменитьРеквизит(Прототип.Идентификатор, СпециальныеСвойства);
		Иначе
			МенеджерПрототипов.ИзменитьСвойство(Прототип.Идентификатор, ТекущиеДанныеСвойств.Свойство, ТекущиеДанныеСвойств.Значение, Ложь, ТекущиеДанныеПрототип.Имя);
			Если ТекущиеДанныеСвойств.Свойство = "КнопкаПоУмолчанию" И ТекущиеДанныеСвойств.Значение = "Да" Тогда
				Прототип.КнопкаПоУмолчанию = ТекущиеДанныеПрототип.Идентификатор;
...
Процедура ДобавитьЭлементУправления(Тип, Вид = "", ТипЗначения = "", ЭтоКолонка = Ложь)
	...
	Если ТекущиеДанные = Неопределено Тогда
		Возврат;
	ИначеЕсли ТекущиеДанные.Тип = МенеджерПрототипов.Типы().ФормаКлиентскогоПриложения
		Или ТекущиеДанные.Тип = МенеджерПрототипов.Типы().ГруппаФормы
		Или ТекущиеДанные.Тип = МенеджерПрототипов.Типы().ТаблицаФормы Тогда
	...
	Если Родитель.Тип <> МенеджерПрототипов.Типы().ФормаКлиентскогоПриложения Тогда
		НоваяСтрока.Родитель = Родитель.Имя;
		
	КонецЕсли;
	
	НоваяСтрока.Прототип = ПолучитьСтрокуПрототипаРекурсивно(Родитель).Идентификатор;
	
	Если Тип = МенеджерПрототипов.Типы().ГруппаФормы Тогда
		Связать = Ложь;
		Если Вид = МенеджерПрототипов.Виды().ОбычнаяГруппа Тогда
			НоваяСтрока.ИндексКартинки = 2;
			НовоеИмя = МенеджерПрототипов.ПолучитьНовоеИмяЭлемента(НоваяСтрока.Прототип, "Группа");
			
		ИначеЕсли Вид = МенеджерПрототипов.Виды().КоманднаяПанель Тогда
			НоваяСтрока.ИндексКартинки = 1;
			НовоеИмя = МенеджерПрототипов.ПолучитьНовоеИмяЭлемента(НоваяСтрока.Прототип, "КоманднаяПанель");
			
		ИначеЕсли Вид = МенеджерПрототипов.Виды().Страницы Тогда
			НоваяСтрока.ИндексКартинки = 19;
			НовоеИмя = МенеджерПрототипов.ПолучитьНовоеИмяЭлемента(НоваяСтрока.Прототип, "Страницы");
			
		ИначеЕсли Вид = МенеджерПрототипов.Виды().Страница Тогда
			НоваяСтрока.ИндексКартинки = 18;
			НовоеИмя = МенеджерПрототипов.ПолучитьНовоеИмяЭлемента(НоваяСтрока.Прототип, "Страница");
			
		ИначеЕсли Вид = МенеджерПрототипов.Виды().Подменю Тогда
			НоваяСтрока.ИндексКартинки = 16;
			НовоеИмя = МенеджерПрототипов.ПолучитьНовоеИмяЭлемента(НоваяСтрока.Прототип, "Подменю");
			
		ИначеЕсли Вид = МенеджерПрототипов.Виды().ГруппаКнопок Тогда
			НоваяСтрока.ИндексКартинки = 9;
			НовоеИмя = МенеджерПрототипов.ПолучитьНовоеИмяЭлемента(НоваяСтрока.Прототип, "ГруппаКнопок");
			
		ИначеЕсли Вид = МенеджерПрототипов.Виды().ГруппаКолонок Тогда
			НоваяСтрока.ИндексКартинки = 10;
			НовоеИмя = МенеджерПрототипов.ПолучитьНовоеИмяЭлемента(НоваяСтрока.Прототип, "ГруппаКолонок");
			
		ИначеЕсли Вид = МенеджерПрототипов.Виды().КонтекстноеМеню Тогда
			НоваяСтрока.ИндексКартинки = 27;
			НовоеИмя = МенеджерПрототипов.ПолучитьНовоеИмяЭлемента(НоваяСтрока.Прототип, "КонтекстноеМеню");
			
		КонецЕсли;
	ИначеЕсли Тип = МенеджерПрототипов.Типы().ПолеФормы Тогда
		Связать = Истина;
		Если Вид = МенеджерПрототипов.Виды().ПолеВвода Тогда
			Если НоваяСтрока.ЭтоКолонка Тогда
				НоваяСтрока.ИндексКартинки = 14;
				НовоеИмя = МенеджерПрототипов.ПолучитьНовоеИмяЭлемента(НоваяСтрока.Прототип, "Колонка");
			...
			Иначе
				...
				НовоеИмя = МенеджерПрототипов.ПолучитьНовоеИмяЭлемента(НоваяСтрока.Прототип, "Поле");
				НоваяСтрока.ПутьКДанным = НовоеИмя;
				НоваяСтрока.Путь = "";
				НоваяСтрока.ТипЗначения = "Строка";
				
			КонецЕсли;
		ИначеЕсли Вид = МенеджерПрототипов.Виды().ПолеФорматированногоДокумента Тогда
			НоваяСтрока.ИндексКартинки = 23;
			НовоеИмя = МенеджерПрототипов.ПолучитьНовоеИмяЭлемента(НоваяСтрока.Прототип, "ФорматированныйДокумент");
			НоваяСтрока.ПутьКДанным = НовоеИмя;
			НоваяСтрока.Путь = "";
		...
		ИначеЕсли Вид = МенеджерПрототипов.Виды().ПолеНадписи Тогда
			// Только для форматированной строки, остальное - Надпись.
			НоваяСтрока.ИндексКартинки = 26;
			НовоеИмя = МенеджерПрототипов.ПолучитьНовоеИмяЭлемента(НоваяСтрока.Прототип, "ФорматированнаяСтрока");
			НоваяСтрока.ПутьКДанным = НовоеИмя;
			НоваяСтрока.Путь = "";
			НоваяСтрока.ТипЗначения = "ФорматированнаяСтрока";
			
		ИначеЕсли Вид = МенеджерПрототипов.Виды().ПолеТекстовогоДокумента Тогда
			НоваяСтрока.ИндексКартинки = 24;
			НовоеИмя = МенеджерПрототипов.ПолучитьНовоеИмяЭлемента(НоваяСтрока.Прототип, "ТекстовыйДокумент");
			НоваяСтрока.ПутьКДанным = НовоеИмя;
			НоваяСтрока.Путь = "";
		...
		ИначеЕсли Вид = МенеджерПрототипов.Виды().ПолеТабличногоДокумента Тогда
			НоваяСтрока.ИндексКартинки = 25;
			НовоеИмя = МенеджерПрототипов.ПолучитьНовоеИмяЭлемента(НоваяСтрока.Прототип, "ТабличныйДокумент");
			НоваяСтрока.ПутьКДанным = НовоеИмя;
			НоваяСтрока.Путь = "";
		...
		ИначеЕсли Вид = МенеджерПрототипов.Виды().ПолеФлажка Тогда
			НоваяСтрока.ИндексКартинки = 20;
			НовоеИмя = МенеджерПрототипов.ПолучитьНовоеИмяЭлемента(НоваяСтрока.Прототип, "Флажок");
			НоваяСтрока.ПутьКДанным = НовоеИмя;
			НоваяСтрока.ТипЗначения = "Булево";
			
		ИначеЕсли Вид = МенеджерПрототипов.Виды().ПолеПереключателя Тогда
			НоваяСтрока.ИндексКартинки = 15;
			НовоеИмя = МенеджерПрототипов.ПолучитьНовоеИмяЭлемента(НоваяСтрока.Прототип, "Переключатель");
			НоваяСтрока.ПутьКДанным = НовоеИмя;
			НоваяСтрока.ТипЗначения = "Строка";
			НоваяСтрока.СписокВыбора = Новый СписокЗначений;
			
		ИначеЕсли Вид = МенеджерПрототипов.Виды().ПолеИндикатора Тогда
			НоваяСтрока.ИндексКартинки = 11;
			НовоеИмя = МенеджерПрототипов.ПолучитьНовоеИмяЭлемента(НоваяСтрока.Прототип, "Индикатор");
			НоваяСтрока.ПутьКДанным = НовоеИмя;
			НоваяСтрока.ТипЗначения = "Число";
			НоваяСтрока.Ширина = 20;
			НоваяСтрока.Высота = 1;
			
		ИначеЕсли Вид = МенеджерПрототипов.Виды().ПолеПолосыРегулирования Тогда
			НоваяСтрока.ИндексКартинки = 17;
			НовоеИмя = МенеджерПрототипов.ПолучитьНовоеИмяЭлемента(НоваяСтрока.Прототип, "ПолосаРегулирования");
			НоваяСтрока.ПутьКДанным = НовоеИмя;
			НоваяСтрока.ТипЗначения = "Число";
			НоваяСтрока.Ширина = 20;
			НоваяСтрока.Высота = 1;
			
		ИначеЕсли Вид = МенеджерПрототипов.Виды().ПолеКалендаря Тогда
			НоваяСтрока.ИндексКартинки = 12;
			НовоеИмя = МенеджерПрототипов.ПолучитьНовоеИмяЭлемента(НоваяСтрока.Прототип, "Календарь");
			НоваяСтрока.ПутьКДанным = НовоеИмя;
			НоваяСтрока.ТипЗначения = "Дата";
			НоваяСтрока.Ширина = 20;
			НоваяСтрока.Высота = 1;
			
		ИначеЕсли Вид = МенеджерПрототипов.Виды().ПолеКартинки Тогда
			НоваяСтрока.ИндексКартинки = 13;
			НовоеИмя = МенеджерПрототипов.ПолучитьНовоеИмяЭлемента(НоваяСтрока.Прототип, "Картинка");
			НоваяСтрока.ПутьКДанным = НовоеИмя;
			НоваяСтрока.ТипЗначения = "Число";
			
		КонецЕсли;
	ИначеЕсли Тип = МенеджерПрототипов.Типы().КнопкаФормы Тогда
		Связать = Истина;
		Если Вид = МенеджерПрототипов.Виды().ОбычнаяКнопка Тогда
			НоваяСтрока.ИндексКартинки = 4;
			НовоеИмя = МенеджерПрототипов.ПолучитьНовоеИмяЭлемента(НоваяСтрока.Прототип, "Кнопка");
			
		ИначеЕсли Вид = МенеджерПрототипов.Виды().КнопкаКоманднойПанели Тогда
			НоваяСтрока.ИндексКартинки = 4;
			НовоеИмя = МенеджерПрототипов.ПолучитьНовоеИмяЭлемента(НоваяСтрока.Прототип, "Кнопка");
			
		ИначеЕсли Вид = МенеджерПрототипов.Виды().Гиперссылка Тогда
			НоваяСтрока.ИндексКартинки = 21;
			НовоеИмя = МенеджерПрототипов.ПолучитьНовоеИмяЭлемента(НоваяСтрока.Прототип, "Гиперссылка");
			
		ИначеЕсли Вид = МенеджерПрототипов.Виды().ГиперссылкаКоманднойПанели Тогда
			НоваяСтрока.ИндексКартинки = 21;
			НовоеИмя = МенеджерПрототипов.ПолучитьНовоеИмяЭлемента(НоваяСтрока.Прототип, "Гиперссылка");
			
		КонецЕсли;
	ИначеЕсли Тип = МенеджерПрототипов.Типы().ТаблицаФормы Тогда
		Связать = Истина;
		Если ТипЗначения = МенеджерПрототипов.ТипыЗначения().ТаблицаЗначений Тогда
			НоваяСтрока.ИндексКартинки = 7;
			НовоеИмя = МенеджерПрототипов.ПолучитьНовоеИмяЭлемента(НоваяСтрока.Прототип, "Таблица");
			НоваяСтрока.ТипЗначения = ТипЗначения;
			
		ИначеЕсли ТипЗначения = МенеджерПрототипов.ТипыЗначения().ДеревоЗначений Тогда
			НоваяСтрока.ИндексКартинки = 8;
			НовоеИмя = МенеджерПрототипов.ПолучитьНовоеИмяЭлемента(НоваяСтрока.Прототип, "Дерево");
			НоваяСтрока.ТипЗначения = ТипЗначения;
			
		КонецЕсли;
	ИначеЕсли Тип = МенеджерПрототипов.Типы().ДекорацияФормы Тогда
		Связать = Ложь;
		Если Вид = МенеджерПрототипов.Виды().Надпись Тогда
			НоваяСтрока.ИндексКартинки = 5;
			НовоеИмя = МенеджерПрототипов.ПолучитьНовоеИмяЭлемента(НоваяСтрока.Прототип, "Надпись");
			
		ИначеЕсли Вид = МенеджерПрототипов.Виды().Картинка Тогда
			НоваяСтрока.ИндексКартинки = 13;
			НовоеИмя = МенеджерПрототипов.ПолучитьНовоеИмяЭлемента(НоваяСтрока.Прототип, "Картинка");
...
Функция ПолучитьИмяТаблицыРекурсивно(ТекущаяСтрока)
	...
	Если Родитель.Тип = МенеджерПрототипов.Типы().ТаблицаФормы Тогда
...
Процедура ВыполнитьПеремещение(ПеремещаемыеЭлементы, ИдентификаторСтрокиПриемника, Перемещенные, Знач ПерваяИтерация = Ложь)
	...
	ЭтоГруппа = Ложь
	Или СтрокаПриемник.Тип = МенеджерПрототипов.Типы().ФормаКлиентскогоПриложения 
	Или СтрокаПриемник.Тип = МенеджерПрототипов.Типы().ГруппаФормы 
	Или СтрокаПриемник.Тип = МенеджерПрототипов.Типы().ТаблицаФормы;
...
Функция ИерархияНеКорректна(СтрокаПриемник, СтрокаИсточник)
	...
	Если СтрокаПриемник.Тип = МенеджерПрототипов.Типы().ГруппаФормы И СтрокаПриемник.Вид = МенеджерПрототипов.Виды().Страницы Тогда
		Если СтрокаИсточник.Тип = МенеджерПрототипов.Типы().ГруппаФормы И СтрокаИсточник.Вид = МенеджерПрототипов.Виды().Страница Тогда
			Результат = Ложь;
		...
		КонецЕсли;
	ИначеЕсли СтрокаПриемник.Тип = МенеджерПрототипов.Типы().ГруппаФормы И СтрокаПриемник.Вид
		= МенеджерПрототипов.Виды().КоманднаяПанель Тогда
		Если СтрокаИсточник.Тип = МенеджерПрототипов.Типы().ГруппаФормы И СтрокаИсточник.Вид = МенеджерПрототипов.Виды().Подменю Тогда
			Результат = Ложь;
			
		ИначеЕсли СтрокаИсточник.Тип = МенеджерПрототипов.Типы().ГруппаФормы И СтрокаИсточник.Вид
			= МенеджерПрототипов.Виды().ГруппаКнопок Тогда
			Результат = Ложь;
			
		ИначеЕсли СтрокаИсточник.Тип = МенеджерПрототипов.Типы().КнопкаФормы И СтрокаИсточник.Вид
			= МенеджерПрототипов.Виды().КнопкаКоманднойПанели Тогда
			Результат = Ложь;
			
		ИначеЕсли СтрокаИсточник.Тип = МенеджерПрототипов.Типы().КнопкаФормы И СтрокаИсточник.Вид
			= МенеджерПрототипов.Виды().ГиперссылкаКоманднойПанели Тогда
			Результат = Ложь;
		...
		КонецЕсли;
	ИначеЕсли СтрокаПриемник.Тип = МенеджерПрототипов.Типы().ТаблицаФормы Тогда
		Если СтрокаИсточник.Тип = МенеджерПрототипов.Типы().ПолеФормы И СтрокаИсточник.Вид = МенеджерПрототипов.Виды().ПолеВвода Тогда
			Результат = Ложь;
			
		ИначеЕсли СтрокаИсточник.Тип = МенеджерПрототипов.Типы().ГруппаФормы И СтрокаИсточник.Вид
			= МенеджерПрототипов.Виды().ГруппаКолонок Тогда
			Результат = Ложь;
			
		ИначеЕсли СтрокаИсточник.Тип = МенеджерПрототипов.Типы().ГруппаФормы И СтрокаИсточник.Вид
			= МенеджерПрототипов.Виды().КонтекстноеМеню Тогда
			Результат = Ложь;
...
Процедура ВыполнитьУдалениеФормыИлиЭлементаУправления()
	...
	Иначе
		СтрокаПрототипа = ПолучитьСтрокуПрототипаРекурсивно(ТекущиеДанные);
		Если ТекущиеДанные.Тип = МенеджерПрототипов.Типы().КнопкаФормы Тогда
		...
		ИначеЕсли ТекущиеДанные.Тип = МенеджерПрототипов.Типы().ГруппаФормы
			Или ТекущиеДанные.Тип = МенеджерПрототипов.Типы().ДекорацияФормы Тогда
...
Процедура ЗаполнитьСвойстваПервымЗначениемДанныхВыбора(НоваяСтрока)
	...
	ПараметрыОтбора.Вставить("ВариантЗаполнения", МенеджерПрототипов.ВариантыЗаполнения().ВыборИзВыпадающегоСписка);
...
Функция ПолучитьКлючиСпециальныеСвойства()
	...
	Результат = "Идентификатор,Имя,Тип,Вид,Родитель,Прототип,Путь,ПутьКДанным,ТипЗначения,Длина,Точность,СоставДаты";
	Возврат Результат;
...
Процедура ЗначениеНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	Если ТекущиеДанныеСвойства.ВариантЗаполнения = МенеджерПрототипов.ВариантыЗаполнения().ВводМножестваЗначений Тогда
		ПараметрыФормы = Новый Структура;
	...
	ИначеЕсли ТекущиеДанныеСвойства.ВариантЗаполнения = МенеджерПрототипов.ВариантыЗаполнения().ВыборИзВыпадающегоСписка Тогда
	...
	ИначеЕсли ТекущиеДанныеСвойства.ВариантЗаполнения = МенеджерПрототипов.ВариантыЗаполнения().ВыборКартинки Тогда
	...
	ИначеЕсли ТекущиеДанныеСвойства.ВариантЗаполнения = МенеджерПрототипов.ВариантыЗаполнения().ВводЗначения Тогда
		ПараметрыФормы = Новый Структура;
		ПараметрыФормы.Вставить("Заголовок", ТекущиеДанныеСвойства.СвойствоПредставление);
		ПараметрыФормы.Вставить("Значение", ТекущиеДанныеСвойства.Значение);
		...
		КонецЕсли;
	ИначеЕсли ТекущиеДанныеСвойства.ВариантЗаполнения = МенеджерПрототипов.ВариантыЗаполнения().ВыборЦвета Тогда
	...
	ИначеЕсли ТекущиеДанныеСвойства.ВариантЗаполнения = МенеджерПрототипов.ВариантыЗаполнения().ВыборШрифта Тогда
...
Функция ПолучитьИмяДанныхВыбора(Свойство, Тип, Вид) 
	...
	Если Свойство = "Группировка" Тогда
		Если Вид = МенеджерПрототипов.Виды().ГруппаКолонок Тогда
	...
	ИначеЕсли Свойство = "Отображение" Тогда
		Если Ложь
			Или Тип = МенеджерПрототипов.Типы().КнопкаФормы
			Или Вид = МенеджерПрототипов.Виды().Подменю
			Тогда
...
Процедура ВыборЦветаЗавершение(Цвет, ДополнительныеПараметры) Экспорт
	...
	ИначеЕсли Цвет.Вид = ВидЦвета.WebЦвет Тогда
		ДанныеВебЦвета = МенеджерПрототипов.ПолучитьДанныеВебЦвета(Цвет);
	...
	ИначеЕсли Цвет.Вид = ВидЦвета.ЭлементСтиля Тогда
		ДанныеЦветаСтиля = МенеджерПрототипов.ПолучитьДанныеЦветаСтиля(Цвет);
