...
Процедура ДобавитьЭлементУправления(Тип, Вид = "", ТипЗначения = "", ЭтоКолонка = Ложь, Источник = Неопределено)
	...
	Иначе
		НоваяСтрока.Имя = Источник.Имя;
		НоваяСтрока.Заголовок = Источник.Заголовок;
...
Процедура ПослеВыбораФормыДляСканирования(ФормаДляСканирования, ДополнительныеПараметры) Экспорт
	...
	сообщить(ФормаДляСканирования.ТестПритест());

	
//	ДанныеСтроки = Элементы.ФормыИЭлементыУправления.ТекущиеДанные;
//	ЗагрузитьОткрытуюФормуВПрототипРекурсивно(ФормаДляСканирования.Элементы, ДанныеСтроки);
//	ЗагрузитьОткрытуюФормуВПрототипНаСервере(ФормаДляСканирования);
	
КонецПроцедуры

Процедура ЗагрузитьОткрытуюФормуВПрототипНаСервере(ФормаДляСканирования)
...
&НаКлиенте
Процедура ЗагрузитьОткрытуюФормуВПрототипРекурсивно(ФормаДляСканирования, ДанныеСтроки)
//	
//	ДочерниеЭлементы = ДанныеСтроки.ПолучитьЭлементы();
...
//		Если ТекущееСвойство = "ТипЗначения"
//			Или ТекущееСвойство = "Длина"
//			Или ТекущееСвойство = "Точность"
//			Тогда
//			Продолжить
//		КонецЕсли;
