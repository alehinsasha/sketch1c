...
Процедура ДобавитьЭлементУправления(Тип, Вид = "", ТипЗначения = "", ЭтоКолонка = Ложь)
	...
	Если Тип = МенеджерПроекта.Типы().ГруппаФормы Тогда
		...
		ИначеЕсли Вид = МенеджерПроекта.Виды().Страницы Тогда
			...
			НоваяСтрока.Имя = НовоеИмя;
			НоваяСтрока.Заголовок = НовоеИмя;
			ЗаполнитьСвойстваЗначениямиПоУмолчанию(НоваяСтрока, "ВертикальноеПоложениеВГруппе,ГоризонтальноеПоложениеВГруппе,ГоризонтальноеПоложениеПодчиненных,ВертикальноеПоложениеПодчиненных");
		...
		ИначеЕсли Вид = МенеджерПроекта.Виды().Страница Тогда
			...
			НоваяСтрока.Имя = НовоеИмя;
			НоваяСтрока.Заголовок = НовоеИмя;
			ЗаполнитьСвойстваЗначениямиПоУмолчанию(НоваяСтрока, "Группировка,ВертикальноеПоложениеВГруппе,ГоризонтальноеПоложениеВГруппе,ГоризонтальноеПоложениеПодчиненных,ВертикальноеПоложениеПодчиненных");
	...
	ИначеЕсли Тип = МенеджерПроекта.Типы().ПолеФормы Тогда
		...
		Если Вид = МенеджерПроекта.Виды().ПолеВвода Тогда
			...
			Если НоваяСтрока.ЭтоКолонка Тогда
				...
				ЗаполнитьСвойстваЗначениямиПоУмолчанию(НоваяСтрока, "ТипЗначения,ПоложениеЗаголовка,ВертикальноеПоложениеВГруппе,ГоризонтальноеПоложениеВГруппе");
		...
		ИначеЕсли Вид = МенеджерПроекта.Виды().ПолеТекстовогоДокумента Тогда
			...
			НоваяСтрока.Заголовок = НовоеИмя;
			НоваяСтрока.Путь = "";
			ЗаполнитьСвойстваЗначениямиПоУмолчанию(НоваяСтрока, "ПоложениеЗаголовка,ТипЗначения,ВертикальноеПоложениеВГруппе,ГоризонтальноеПоложениеВГруппе");
		...
		ИначеЕсли Вид = МенеджерПроекта.Виды().ПолеПереключателя Тогда
			...
			ЗаполнитьСвойстваЗначениямиПоУмолчанию(НоваяСтрока, "ТипЗначения,ПоложениеЗаголовка,ВидПереключателя,ВертикальноеПоложениеВГруппе,ГоризонтальноеПоложениеВГруппе");
		...
		ИначеЕсли Вид = МенеджерПроекта.Виды().ПолеКартинки Тогда
			...
			НоваяСтрока.ПутьКДанным = НовоеИмя;
			НоваяСтрока.Заголовок = НовоеИмя;
			ЗаполнитьСвойстваЗначениямиПоУмолчанию(НоваяСтрока, "ТипЗначения,ПоложениеЗаголовка,Гиперссылка,ВертикальноеПоложениеВГруппе,ГоризонтальноеПоложениеВГруппе");
