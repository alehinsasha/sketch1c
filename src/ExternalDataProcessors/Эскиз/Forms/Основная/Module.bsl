...
Процедура ЗагрузитьОткрытуюФормуВПрототипРекурсивно(ТекущаяСтрока, КоллекцияЭлементов)
	...
	Для Каждого Элемент Из КоллекцияЭлементов Цикл
		...
		Если Элемент.ПодчиненныеЭлементы.Количество() Тогда
			ЗагрузитьОткрытуюФормуВПрототипРекурсивно(ТекущаяСтрока, Элемент.ПодчиненныеЭлементы);		
		КонецЕсли;
	КонецЦикла;
...
Процедура ЗагрузитьПрототипИзФормыКонфигурации(Команда)
	Сообщить("ЗагрузитьПрототипИзФормыКонфигурации");
КонецПроцедуры
