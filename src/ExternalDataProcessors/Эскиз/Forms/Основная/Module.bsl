...
Процедура ЗагрузитьПрототип(Команда)
	...
	Оповещение = Новый ОписаниеОповещения("ПослеВыбораВариантаЗагрузкиПрототипа", ЭтотОбъект);
	
	ВариантыЗагрузкиПрототипа = ВариантыЗагрузкиПрототипа();
	
	СписокВариантов = Новый СписокЗначений();
	СписокВариантов.Добавить(ВариантыЗагрузкиПрототипа.ИзКаталога, "Из каталога");
	СписокВариантов.Добавить(ВариантыЗагрузкиПрототипа.ИзФормКонфигурации, "Из форм конфигурации");
	СписокВариантов.Добавить(ВариантыЗагрузкиПрототипа.ИзОткрытыхФорм, "Из открытых форм");
	
	ПоказатьВыборИзСписка(Оповещение, СписокВариантов, Команда);
...
&НаКлиенте
Функция ВариантыЗагрузкиПрототипа()
	
	ИсходнаяСтруктура = Новый Структура();
	ИсходнаяСтруктура.Вставить("ИзКаталога", "ИзКаталога");
	ИсходнаяСтруктура.Вставить("ИзФормКонфигурации", "ИзФормКонфигурации");
	ИсходнаяСтруктура.Вставить("ИзОткрытыхФорм", "ИзОткрытыхФорм");
...
&НаКлиенте
Процедура ПослеВыбораВариантаЗагрузкиПрототипа(Результат, ДополнительныеПараметры) Экспорт
	
	ВариантыЗагрузкиПрототипа = ВариантыЗагрузкиПрототипа();
	Если Результат = ВариантыЗагрузкиПрототипа.ИзКаталога Тогда
...
Процедура СохранитьПрототип(Команда)
	...
	Иначе
		Оповещение = Новый ОписаниеОповещения("ПослеВыбораРасположенияФайла", ЭтотОбъект);
...
&НаКлиенте
Процедура ПослеВыбораРасположенияФайла(ВыбранныеФайлы, ДополнительныеПараметры) Экспорт
