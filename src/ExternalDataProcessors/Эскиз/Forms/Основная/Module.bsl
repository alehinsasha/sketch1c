...
Функция ЗагрузитьПрототипНаСервере(Адрес, Идентификатор, Замена, РасположениеФайла) 
	...
	Если ФайлПрототипа.Количество() Тогда
		...
		ФормыИЭлементыУправленияИзМассиваРекурсивно(ФайлПрототипа.Элементы, ФормыИЭлементыУправленияНаСервере.Строки, Истина, Замена, РасположениеФайла);
	...
	Для Каждого Элемент Из КоллекцияЭлементов Цикл
		...
		Если ТипЗначенияТекущегоЭлемента = Тип("ПолеФормы") Тогда
			...
			ИначеЕсли Элемент.Вид = ВидПоляФормы.ПолеПолосыРегулирования Тогда						
				НовыйЭлемент = НовыйЭлементУправления(Типы.ПолеФормы, Виды.ПолеПолосыРегулирования,, Элемент, ТекущаяСтрока);
			...
			ИначеЕсли Элемент.Вид = ВидПоляФормы.ПолеФорматированногоДокумента Тогда						
				НовыйЭлемент = НовыйЭлементУправления(Типы.ПолеФормы, Виды.ПолеФорматированногоДокумента,, Элемент, ТекущаяСтрока);
			...
			ИначеЕсли Элемент.Вид = ВидПоляФормы.ПолеТекстовогоДокумента Тогда						
				НовыйЭлемент = НовыйЭлементУправления(Типы.ПолеФормы, Виды.ПолеТекстовогоДокумента,, Элемент, ТекущаяСтрока);
			ИначеЕсли Элемент.Вид = ВидПоляФормы.ПолеТабличногоДокумента Тогда						
				НовыйЭлемент = НовыйЭлементУправления(Типы.ПолеФормы, Виды.ПолеТабличногоДокумента,, Элемент, ТекущаяСтрока);
			КонецЕсли;
		...
		ИначеЕсли ТипЗначенияТекущегоЭлемента = Тип("КнопкаФормы") Тогда
			...
			ИначеЕсли Элемент.Вид = ВидКнопкиФормы.КнопкаКоманднойПанели Тогда
				НовыйЭлемент = НовыйЭлементУправления(Типы.КнопкаФормы, Виды.КнопкаКоманднойПанели,, Элемент, ТекущаяСтрока);
			...
			ИначеЕсли Элемент.Вид = ВидКнопкиФормы.ГиперссылкаКоманднойПанели Тогда
				НовыйЭлемент = НовыйЭлементУправления(Типы.КнопкаФормы, Виды.ГиперссылкаКоманднойПанели,, Элемент, ТекущаяСтрока);
			КонецЕсли;
		ИначеЕсли ТипЗначенияТекущегоЭлемента = Тип("ТаблицаФормы") Тогда
			ЕстьПодчиненныеЭлементы = Истина;
			
			НовыйЭлемент = НовыйЭлементУправления(Типы.ТаблицаФормы,, ТипыЗначения.ТаблицаЗначений, Элемент, ТекущаяСтрока);
...
Процедура ОбновитьПредставлениеЗначенияСвойства(СтрокаСвойства)
	...
	СтрокаСвойства.ЗначениеПредставление =
		?(ЗначениеЗаполнено(СтрокаСвойства.Значение), СтрокаСвойства.Значение, ПредставлениеПустогоЗначения);
