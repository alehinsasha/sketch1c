...
&НаКлиенте
Процедура ДобавитьЭлементУправления(Тип, Вид = "", ТипЗначения = "", Источник = Неопределено)
...
Процедура ПослеВыбораФормыДляСканирования(ФормаДляСканирования, ДополнительныеПараметры) Экспорт
	...
	ЗагрузитьОткрытуюФормуВПрототипРекурсивно(СтрокаПрототип, ФормаДляСканирования.Элементы);
	...
	Для Каждого Элемент Из КоллекцияЭлементов Цикл
		...
		Если ТипЗначенияТекущегоЭлемента = Тип("ПолеФормы") Тогда
			...
			ИначеЕсли Элемент.Вид = ВидПоляФормы.ПолеФлажка Тогда						
				ДобавитьЭлементУправления(Типы.ПолеФормы, Виды.ПолеФлажка,, Элемент);
			ИначеЕсли Элемент.Вид = ВидПоляФормы.ПолеПереключателя Тогда						
				ДобавитьЭлементУправления(Типы.ПолеФормы, Виды.ПолеПереключателя,, Элемент);
			ИначеЕсли Элемент.Вид = ВидПоляФормы.ПолеКартинки Тогда						
				ДобавитьЭлементУправления(Типы.ПолеФормы, Виды.ПолеКартинки,, Элемент);
			ИначеЕсли Элемент.Вид = ВидПоляФормы.ПолеИндикатора Тогда						
				ДобавитьЭлементУправления(Типы.ПолеФормы, Виды.ПолеИндикатора,, Элемент);
			ИначеЕсли Элемент.Вид = ВидПоляФормы.ПолеПолосыРегулирования Тогда						
				ДобавитьЭлементУправления(Типы.ПолеФормы, Виды.ПолеПолосыРегулирования,, Элемент);
			ИначеЕсли Элемент.Вид = ВидПоляФормы.ПолеКалендаря Тогда						
				ДобавитьЭлементУправления(Типы.ПолеФормы, Виды.ПолеКалендаря,, Элемент);
			ИначеЕсли Элемент.Вид = ВидПоляФормы.ПолеФорматированногоДокумента Тогда						
				ДобавитьЭлементУправления(Типы.ПолеФормы, Виды.ПолеФорматированногоДокумента,, Элемент);
			ИначеЕсли Элемент.Вид = ВидПоляФормы.ПолеНадписи Тогда						
				ДобавитьЭлементУправления(Типы.ПолеФормы, Виды.ПолеНадписи,, Элемент);
			ИначеЕсли Элемент.Вид = ВидПоляФормы.ПолеТекстовогоДокумента Тогда						
				ДобавитьЭлементУправления(Типы.ПолеФормы, Виды.ПолеТекстовогоДокумента,, Элемент);
			ИначеЕсли Элемент.Вид = ВидПоляФормы.ПолеТабличногоДокумента Тогда						
				ДобавитьЭлементУправления(Типы.ПолеФормы, Виды.ПолеТабличногоДокумента,, Элемент);
			КонецЕсли;
		ИначеЕсли ТипЗначенияТекущегоЭлемента = Тип("ГруппаФормы") Тогда
			Если Элемент.Вид = ВидГруппыФормы.ОбычнаяГруппа Тогда
				ДобавитьЭлементУправления(Типы.ГруппаФормы, Виды.ОбычнаяГруппа,, Элемент);
			ИначеЕсли Элемент.Вид = ВидГруппыФормы.КоманднаяПанель Тогда
				ДобавитьЭлементУправления(Типы.ГруппаФормы, Виды.КоманднаяПанель,, Элемент);
			ИначеЕсли Элемент.Вид = ВидГруппыФормы.Подменю Тогда
				ДобавитьЭлементУправления(Типы.ГруппаФормы, Виды.Подменю,, Элемент);
			ИначеЕсли Элемент.Вид = ВидГруппыФормы.Страницы Тогда
				ДобавитьЭлементУправления(Типы.ГруппаФормы, Виды.Страницы,, Элемент);
			ИначеЕсли Элемент.Вид = ВидГруппыФормы.Страница Тогда
				ДобавитьЭлементУправления(Типы.ГруппаФормы, Виды.Страница,, Элемент);
			ИначеЕсли Элемент.Вид = ВидГруппыФормы.ГруппаКолонок Тогда
				ДобавитьЭлементУправления(Типы.ГруппаФормы, Виды.ГруппаКолонок,, Элемент);
			ИначеЕсли Элемент.Вид = ВидГруппыФормы.КонтекстноеМеню Тогда
				ДобавитьЭлементУправления(Типы.ГруппаФормы, Виды.КонтекстноеМеню,, Элемент);
			ИначеЕсли Элемент.Вид = ВидГруппыФормы.ГруппаКнопок Тогда
				ДобавитьЭлементУправления(Типы.ГруппаФормы, Виды.ГруппаКнопок,, Элемент);
			КонецЕсли;
		ИначеЕсли ТипЗначенияТекущегоЭлемента = Тип("КнопкаФормы") Тогда
			Если Элемент.Вид = ВидКнопкиФормы.ОбычнаяКнопка Тогда
				ДобавитьЭлементУправления(Типы.КнопкаФормы, Виды.ОбычнаяКнопка,, Элемент);
			ИначеЕсли Элемент.Вид = ВидКнопкиФормы.КнопкаКоманднойПанели Тогда
				ДобавитьЭлементУправления(Типы.КнопкаФормы, Виды.КнопкаКоманднойПанели,, Элемент);
			ИначеЕсли Элемент.Вид = ВидКнопкиФормы.Гиперссылка Тогда
				ДобавитьЭлементУправления(Типы.КнопкаФормы, Виды.Гиперссылка,, Элемент);
			ИначеЕсли Элемент.Вид = ВидКнопкиФормы.ГиперссылкаКоманднойПанели Тогда
				ДобавитьЭлементУправления(Типы.КнопкаФормы, Виды.ГиперссылкаКоманднойПанели,, Элемент);
			КонецЕсли;
		ИначеЕсли ТипЗначенияТекущегоЭлемента = Тип("ТаблицаФормы") Тогда
			ДобавитьЭлементУправления(Типы.ТаблицаФормы,, ТипыЗначения.ТаблицаЗначений, Элемент);
		ИначеЕсли ТипЗначенияТекущегоЭлемента = Тип("ДекорацияФормы") Тогда
			ДобавитьЭлементУправления(Типы.ДекорацияФормы, Виды.Надпись,, Элемент);
		КонецЕсли;
		
		ДочерниеЭлементы = КоллекцияЭлементов.ПолучитьЭлементы();
		Если ДочерниеЭлементы.Количество() Тогда
//			ЗагрузитьОткрытуюФормуВПрототипРекурсивно();
		КонецЕсли;
	КонецЦикла;
