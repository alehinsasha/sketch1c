...
Процедура СоздатьПрототип(Команда)
	...
	НовоеИмя = "Новая форма"; // TODO: удалить если не нужен МенеджерПрототипов.ПолучитьНовоеИмяФормы();
...
&НаКлиенте
Функция НовоеИмяЭлементаУправления(ИдентификаторПрототипа, Вид)
	
	Счетчики[ИдентификаторПрототипа][Вид] = Счетчики[ИдентификаторПрототипа][Вид] + 1;
	Возврат СтрШаблон("%1%2", Вид, Счетчики[ИдентификаторПрототипа][Вид]);
